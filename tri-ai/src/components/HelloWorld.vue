  ...
  <div class="container mx-auto">
    ...
    <div class="flex flex-wrap">
      <div class="w-full mb-8 lg:mb-0 lg:w-1/2 xl:w-2/3 xl:pr-56 text-left container mx-auto">
        <h1 class="text-3xl sm:text-5xl lg:text-6xl text-white mt-4 font-medium">
          Training, Research and Innovation in
          <span class="text-yellow-600">Artificial Intelligence</span>
        </h1>
        <h2
          class="text-xl mt-4 text-white"
        >Tri-ai organisation is an NGO committed to revolutionising the training, research and innovation in artificial intelligence in Africa. We have set out plans and agenda to achieve this.</h2>
      ...
      <div class="bg-gray-900 w-full lg:w-1/2 xl:w-1/3 py-2 container mx-auto">
        ...
        >AISaturdays Africa is one of the subsidiaries of Tri-ai. If you wish to start a version of AI saturdays in an African city near you, please fill the form below:</p>
        <form
        ...
        >
          ...
          <div class="mb-4">
            <label class="block text-gray-300 text-sm font-bold mb-2" for="username">Your location?</label>
            <input
              class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
