...
import { ExtendConfig, OmitFirst, TLinkElement, SlateEditor } from 'platejs';
import { B as BaseLinkConfig, g as getLinkAttributes } from '../getLinkAttributes-BiNH3pu-.mjs';
import * as React$1 from 'react';
import React__default from 'react';
import * as csstype from 'csstype';
import * as _platejs_floating from '@platejs/floating';
import { UseVirtualFloatingOptions } from '@platejs/floating';
...
declare const LinkPlugin: platejs_react.PlatePlugin<platejs.PluginConfig<"a", {
...
declare const useFloatingLinkInsertState: ({ floatingOptions, }?: LinkFloatingToolbarState) => {
    floating: _platejs_floating.UseVirtualFloatingReturn<_floating_ui_react.ReferenceType>;
    focused: boolean;
    isOpen: any;
    readOnly: boolean;
    triggerFloatingLinkHotkeys: string | (string[] & string) | undefined;
};
declare const useFloatingLinkInsert: ({ floating, focused, isOpen, readOnly, triggerFloatingLinkHotkeys, }: ReturnType<typeof useFloatingLinkInsertState>) => {
    hidden: boolean;
    props: {
        style: {
            zIndex: number;
...
declare const useVirtualFloatingLink: ({ editorId, ...floatingOptions }: {
    editorId: string;
} & UseVirtualFloatingOptions) => _platejs_floating.UseVirtualFloatingReturn<_floating_ui_react.ReferenceType>;

/**
 * Insert link if url is valid. Text is url if empty. Close floating link. Focus
 * editor.
 */
declare const submitFloatingLink: (editor: SlateEditor) => true | undefined;

declare const triggerFloatingLink: (editor: SlateEditor, { focused, }?: {
    focused?: boolean;
}) => void;

declare const triggerFloatingLinkEdit: (editor: SlateEditor) => true | undefined;
 ...
 */
declare const triggerFloatingLinkInsert: (editor: SlateEditor, { focused, }?: {
    focused?: boolean;
}) => true | undefined;

export { type FloatingLinkMode, FloatingLinkNewTabInput, FloatingLinkUrlInput, type LinkConfig, type LinkFloatingToolbarState, LinkOpenButton, LinkPlugin, submitFloatingLink, triggerFloatingLink, triggerFloatingLinkEdit, triggerFloatingLinkInsert, useFloatingLinkEdit, useFloatingLinkEditState, useFloatingLinkEnter, useFloatingLinkEscape, useFloatingLinkInsert, useFloatingLinkInsertState, useFloatingLinkNewTabInput, useFloatingLinkNewTabInputState, useFloatingLinkUrlInput, useFloatingLinkUrlInputState, useLink, useLinkOpenButton, useLinkOpenButtonState, useLinkToolbarButton, useLinkToolbarButtonState, useVirtualFloatingLink };
