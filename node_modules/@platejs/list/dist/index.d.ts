...
export { a as BaseListPlugin, U as ULIST_STYLE_TYPES, g as getSiblingList } from './BaseListPlugin-PGMEFnhS.js';
import { OverrideEditor, Editor, NodeEntry, ElementOf, ElementEntryOf, EditorAboveOptions, SlateEditor, TElement, TLocation, Path } from 'platejs';
 ...
 *   children
 */
declare const expandListItemsWithChildren: <N extends ElementOf<E>, E extends Editor = Editor>(editor: E, entries: ElementEntryOf<E>[]) => NodeEntry<N>[];
 ...
 */
declare const getListChildren: <N extends ElementOf<E>, E extends Editor = Editor>(editor: E, entry: ElementEntryOf<E>) => NodeEntry<N>[];
...
export { BaseListConfig, type GetListSiblingsOptions, GetSiblingListOptions, type ListOptions, ListStyleType, areEqListStyleType, expandListItemsWithChildren, getListAbove, getListChildren, getListExpectedListStart, getListSiblings, getNextList, getPreviousList, getSiblingListStyleType, indentList, indentTodo, isOrderedList, normalizeListNotIndented, normalizeListStart, outdentList, setIndentTodoNode, setListNode, setListNodes, setListSiblingNodes, someList, someTodoList, toggleList, toggleListByPath, toggleListByPathUnSet, toggleListSet, toggleListUnset, withInsertBreakList, withList, withNormalizeList };
