...
__export(index_exports, {
  ...
  createStaticEditor: () => createStaticEditor,
  ...
  getSelectedDomBlocks: () => getSelectedDomBlocks,
  getSelectedDomFragment: () => getSelectedDomFragment,
  ...
  getStaticPlugins: () => getStaticPlugins,
  ...
  isSelectOutside: () => isSelectOutside,
  ...
  pipeOnNodeChange: () => pipeOnNodeChange,
  pipeOnTextChange: () => pipeOnTextChange,
...
var SlateText = import_react.default.forwardRef(({ as: Tag = "span", children, ...props }, ref) => {
  const attributes = useNodeAttributes(props, ref);
  return /* @__PURE__ */ import_react.default.createElement(Tag, { ...attributes }, children);
});
var NonBreakingSpace = () => /* @__PURE__ */ import_react.default.createElement("span", { style: { fontSize: 0, lineHeight: 0 }, contentEditable: false }, String.fromCodePoint(160));
var SlateLeaf = import_react.default.forwardRef(({ as: Tag = "span", children, inset, ...props }, ref) => {
  const attributes = useNodeAttributes(props, ref);
  if (inset) {
    return /* @__PURE__ */ import_react.default.createElement(import_react.default.Fragment, null, /* @__PURE__ */ import_react.default.createElement(NonBreakingSpace, null), /* @__PURE__ */ import_react.default.createElement(Tag, { ...attributes }, children, /* @__PURE__ */ import_react.default.createElement(NonBreakingSpace, null)));
  }
  return /* @__PURE__ */ import_react.default.createElement(Tag, { ...attributes }, children);
});
...
var renderComponentToHtml = (ReactDOMServer, Component, props) => {
  return (0, import_html_entities.decode)(
    ReactDOMServer.renderToStaticMarkup(import_react8.default.createElement(Component, props))
  );
};
...
var normalizeNodeId = (value, options = {}) => {
  ...
  const normalizeNode = (node, path) => {
    ...
    if (!clonedNode[idKey] && (0, import_slate22.queryNode)([clonedNode, path], {
      allow,
      exclude,
      filter: (entry) => {
        const [node2] = entry;
        ...
        if (filterInline && import_slate22.ElementApi.isElement(node2) && // For static normalization, we can't use editor.api.isBlock
    ...
    if (import_slate22.ElementApi.isElement(clonedNode)) {
...
var createSlateEditor = ({
  editor = (0, import_slate27.createEditor)(),
  ...options
} = {}) => {
  return withSlate(editor, options);
};
