...
import { SlateEditor, ElementEntry, EditorNodesOptions, Path, PluginConfig, OmitFirst, OverrideEditor, NodeEntry, Descendant, TLocation, Point, TRange, TElement, Ancestor } from 'platejs';
export { B as BaseTodoListPlugin, T as TTodoListItemElement } from './BaseTodoListPlugin-CjzKTmKi.mjs';
...
declare const BaseBulletedListPlugin: platejs.SlatePlugin<PluginConfig<"ul", {}, {}, Record<"ul", {
    toggle: () => void;
}>, {}>>;
declare const BaseNumberedListPlugin: platejs.SlatePlugin<PluginConfig<"ol", {}, {}, Record<"ol", {
    toggle: () => void;
}>, {}>>;
declare const BaseTaskListPlugin: platejs.SlatePlugin<PluginConfig<"taskList", {
    inheritCheckStateOnLineEndBreak: boolean;
    inheritCheckStateOnLineStartBreak: boolean;
}, {}, Record<"taskList", {
    toggle: () => void;
}>, {}>>;
declare const BaseListItemPlugin: platejs.SlatePlugin<PluginConfig<"li", {}, {}, {}, {}>>;
declare const BaseListItemContentPlugin: platejs.SlatePlugin<PluginConfig<"lic", {}, {}, {}, {}>>;
/** Enables support for bulleted, numbered and to-do lists. */
declare const BaseListPlugin: platejs.SlatePlugin<PluginConfig<"listClassic", {
    enableResetOnShiftTab?: boolean;
    /** Inherit the checked state of above node after insert break at the end */
    inheritCheckStateOnLineEndBreak?: boolean;
    /** Inherit the checked state of below node after insert break at the start */
...
declare const getPropsIfTaskListLiNode: (editor: SlateEditor, { inherit, liNode: node }: GetPropsIfTaskListLiNodeOptions) => {
    checked: boolean;
} | undefined;
