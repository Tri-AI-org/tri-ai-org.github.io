...
function useRecordHotkeys() {
  const [keys, setKeys] = (0, import_react3.useState)(/* @__PURE__ */ new Set());
  const [isRecording, setIsRecording] = (0, import_react3.useState)(false);
  const handler = (0, import_react3.useCallback)((event) => {
  ...
  const resetKeys = (0, import_react3.useCallback)(() => {
    setKeys(/* @__PURE__ */ new Set());
  }, []);
...
var useSafeLayoutEffect = typeof window === "undefined" ? import_react5.useEffect : import_react5.useLayoutEffect;
function useHotkeys(keys, callback, options, dependencies) {
  const [ref, setRef] = (0, import_react5.useState)(null);
  const hasTriggeredRef = (0, import_react5.useRef)(false);
  const _options = Array.isArray(options) ? Array.isArray(dependencies) ? void 0 : dependencies : options;
  const _keys = (0, import_react5.useMemo)(() => {
  ...
  const memoisedCB = (0, import_react5.useCallback)(callback, _deps != null ? _deps : []);
  const cbRef = (0, import_react5.useRef)(memoisedCB);
