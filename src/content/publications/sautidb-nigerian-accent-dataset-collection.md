...
abstract: SautiDB is an ongoing effort to build a comprehensive collection of
  ...
  backgrounds can contribute voice samples. The dataset covers speakers of
  Yorùbá, Ìgbò, Ẹdó, Efik-Ibibio, Igala, and Hausa, and is designed to support
  the development of voice technology that is inclusive of Nigerian users.
  Originally released in February 2021 with 919 samples across five languages,
  the collection has since grown to 1,137 samples with the addition of Hausa in
  version 1.2. This work originated from research into accent transfer
  technology aimed at improving online learning experiences for non-native
  English speakers.
